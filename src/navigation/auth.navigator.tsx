...
import { ResetPasswordScreen, SignInScreen, SignUpScreen, StartedScreen } from '../scenes/auth';

type AuthNavigatorParams = AppNavigatorParams & {
  [AppRoute.STARTED]: undefined;
...
export const AuthNavigator = (): React.ReactElement => (
  <Stack.Navigator headerMode='none'>
    <Stack.Screen name={AppRoute.STARTED} component={StartedScreen}/>
